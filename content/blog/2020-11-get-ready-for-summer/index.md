...
resources:
- name: feature
  src: toes-in-sand.jpg
  params:
    alt: Woman's feet at the beach.
- name: rewards
  src: rewards.png
  params:
    alt: Rewards image.
...
[Book now!](https://bookings.gettimely.com/massagemedayspa/bb/book?category=128491)

This offer will also be available in voucher form. If you'd like to have a look at what voucher's we have on offer, you can [click here](/gift-vouchers) to go to our gift voucher page.
